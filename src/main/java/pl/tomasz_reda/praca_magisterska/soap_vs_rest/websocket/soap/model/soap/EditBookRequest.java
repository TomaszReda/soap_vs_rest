...
@XmlRootElement(name = "EditBookRequest", namespace = "https://www.praca_magister/soap_vs_rest/books.com")
public class EditBookRequest {

    @XmlElement(namespace = "https://www.praca_magister/soap_vs_rest/books.com")
    protected long id;
    @XmlElement(namespace = "https://www.praca_magister/soap_vs_rest/books.com", required = true)
